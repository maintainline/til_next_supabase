...
- 서버상태를 불러오고, 캐싱하며, 지속적으로 동기화 하고, 업데이트하는 라이브러리
...
- 아래는 Next.js 에서 제공하는 api 와 혼돈하지 마셔옹
...
export function useUserSelection() {
  ...
  return {
    ...
    // 액션들
    selectUer: (userId: number) => setSelectedUserId(userId),
